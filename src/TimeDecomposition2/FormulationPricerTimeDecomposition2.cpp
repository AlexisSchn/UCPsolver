...
FormulationPricerTimeDecomposition2::FormulationPricerTimeDecomposition2(InstanceUCP *instance, 
    SCIP *scip,
    int block_number,
    ...
    m_reduced_costs_pmax( reduced_costs_pmax),
    m_reduced_costs_pmin( reduced_costs_pmin )
{
...
SCIP_RETCODE FormulationPricerTimeDecomposition2::create_variables()
{
    ...
    for(int i_unit = 0; i_unit < number_of_units; i_unit ++)
    {
        ...
        coefficient -= production_max[i_unit] * m_reduced_costs_pmax[i_unit][m_block_number];
        coefficient += production_min[i_unit] * m_reduced_costs_pmin[i_unit][m_block_number];
...
SCIP_RETCODE FormulationPricerTimeDecomposition2::create_constraints()
{
...
ProductionPlan* FormulationPricerTimeDecomposition2::get_production_plan_from_solution()
{
...
int FormulationPricerTimeDecomposition2::get_unit_number()
{
