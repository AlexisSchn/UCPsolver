...
FormulationPricerTimeDecomposition2pmin::FormulationPricerTimeDecomposition2pmin(InstanceUCP *instance, 
    SCIP *scip,
    int block_number,
...
SCIP_RETCODE FormulationPricerTimeDecomposition2pmin::create_variables()
{
    ...
    for(int i_unit = 0; i_unit < number_of_units; i_unit ++)
    {
        ...
        coefficient -= production_min[i_unit] * m_reduced_costs_demand[m_block_number];

        // Pmax or Pmin Cost
        coefficient += production_min[i_unit] * proportionnal_costs[i_unit];
...
SCIP_RETCODE FormulationPricerTimeDecomposition2pmin::create_constraints()
{
...
ProductionPlan* FormulationPricerTimeDecomposition2pmin::get_production_plan_from_solution()
{
    ...
    for( int i_unit = 0; i_unit < number_of_units; i_unit ++)
    {
        ...
        quantity_plan[i_unit][m_block_number] += production_min[i_unit] * up_down_plan[i_unit][m_block_number];
...
int FormulationPricerTimeDecomposition2pmin::get_unit_number()
{
