/** 
 * @file
 * Implement the class ObjPricerUCPTimeDecomposition2pmax 
*/
...
/** constructor */
ObjPricerUCPTimeDecomposition2pmax::ObjPricerUCPTimeDecomposition2pmax(
 ...
 *  problem.
 */
SCIP_DECL_PRICERINIT(ObjPricerUCPTimeDecomposition2pmax::scip_init)
{
...
SCIP_DECL_PRICERREDCOST(ObjPricerUCPTimeDecomposition2pmax::scip_redcost)
{
    /* set result pointer */
    *result = SCIP_SUCCESS;
...
SCIP_RETCODE ObjPricerUCPTimeDecomposition2pmax::ucp_pricing(SCIP* scip)
{
    ...
    {   
        ...
        FormulationPricerTimeDecomposition2pmax formulation_pricer( m_instance_ucp, 
            scip_pricer,
            i_time_step,
