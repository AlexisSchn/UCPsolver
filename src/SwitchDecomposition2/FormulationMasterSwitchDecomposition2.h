...
/** 
 * @class FormulationMasterSwitchDecomposition2
 * 
...
#ifndef FormulationMasterSwitchDecomposition2_H
#define FormulationMasterSwitchDecomposition2_H
...
class FormulationMasterSwitchDecomposition2 : public FormulationMaster
{
    ...
    public:
         ...
         *  constructor 
        */
        FormulationMasterSwitchDecomposition2( 
