...
/**
 * 
 *  Implements the class FormulationMasterTimeDecomposition2pmax
*/
...
FormulationMasterTimeDecomposition2pmax::FormulationMasterTimeDecomposition2pmax( InstanceUCP* instance, SCIP* scip_master):
...
FormulationMasterTimeDecomposition2pmax::~FormulationMasterTimeDecomposition2pmax()
{
...
SCIP_RETCODE FormulationMasterTimeDecomposition2pmax::create_variables()
{
...
SCIP_RETCODE FormulationMasterTimeDecomposition2pmax::create_constraints()
{
...
SCIP_RETCODE FormulationMasterTimeDecomposition2pmax::create_and_add_first_columns()
{
...
SCIP_RETCODE FormulationMasterTimeDecomposition2pmax::add_column( ProductionPlan* plan_of_new_column, bool initialization, int block_number ) 
{
    int number_of_time_steps( m_instance_ucp->get_time_steps_number() );
    int number_of_units( m_instance_ucp->get_units_number());
...
ProductionPlan* FormulationMasterTimeDecomposition2pmax::get_production_plan_from_solution()
{
    ...
    for(int i_column = 0; i_column < number_columns; i_column ++)
    {
        ...
        for( int i_unit = 0; i_unit < number_of_units; i_unit++ )
        {
            ...
            quantity_plan[i_unit][current_block] += current_up_down_plan[i_unit][current_block]*coefficient_column * production_max[i_unit];
        }
    }
...
SCIP_CONS** FormulationMasterTimeDecomposition2pmax::get_constraint_convexity( int number_block )
{
    return( &m_constraints_convexity[number_block]);
}

SCIP_Cons** FormulationMasterTimeDecomposition2pmax::get_constraint_min_uptime( int number_unit, int number_time_step )
{
    return( &m_constraints_min_uptime[number_unit][number_time_step]);
}

SCIP_Cons** FormulationMasterTimeDecomposition2pmax::get_constraint_min_downtime( int number_unit, int number_time_step )
{
    return( &m_constraints_min_downtime[number_unit][number_time_step]);
}

SCIP_Cons** FormulationMasterTimeDecomposition2pmax::get_constraint_switch( int number_unit, int number_time_step )
{
    return( &m_constraints_switch[number_unit][number_time_step]);
}


SCIP_Cons** FormulationMasterTimeDecomposition2pmax::get_constraint_pmaxpmin( int number_unit, int number_time_step )
{
    return( &m_constraints_pmaxpmin[number_unit][number_time_step]);
}

SCIP_Cons** FormulationMasterTimeDecomposition2pmax::get_constraint_demand( int number_time_step )
{
...
int FormulationMasterTimeDecomposition2pmax::get_columns_number()
{
