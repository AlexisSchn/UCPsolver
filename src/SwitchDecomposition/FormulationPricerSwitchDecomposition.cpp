...
FormulationPricerSwitchDecomposition::FormulationPricerSwitchDecomposition(InstanceUCP *instance, 
    SCIP *scip,
    int block_number,
...
SCIP_RETCODE FormulationPricerSwitchDecomposition::create_variables()
{
...
SCIP_RETCODE FormulationPricerSwitchDecomposition::create_constraints()
{
...
SCIP_RETCODE FormulationPricerSwitchDecomposition::change_reduced_costs( 
...
)
{
    ...
    for(int i_unit = 0; i_unit < number_of_units; i_unit ++)
    {
        ...
        // u
        coefficient = 0.;
        coefficient += 1 * startup_costs[ i_unit ];
...
ProductionPlan* FormulationPricerSwitchDecomposition::get_production_plan_from_solution()
{
...
int FormulationPricerSwitchDecomposition::get_block_number()
{
