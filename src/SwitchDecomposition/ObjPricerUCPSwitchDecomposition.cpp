/** 
 * @file
 * Implement the class ObjPricerUCPSwitchDecomposition 
*/
...
/** constructor */
ObjPricerUCPSwitchDecomposition::ObjPricerUCPSwitchDecomposition(
    ...
    ObjPricer(scip_master, name, "Pricer", 0, TRUE)
{
    ...
    {   
        ...
        FormulationPricerSwitchDecomposition* formulation_pricer = new FormulationPricerSwitchDecomposition( 
            m_instance_ucp, 
            scip_pricer,
            i_time_step,
 ...
 *  problem.
 */
SCIP_DECL_PRICERINIT(ObjPricerUCPSwitchDecomposition::scip_init)
{
    int number_of_units( m_instance_ucp->get_units_number());
    int number_of_time_steps( m_instance_ucp->get_time_steps_number());
...
SCIP_DECL_PRICERREDCOST(ObjPricerUCPSwitchDecomposition::scip_redcost)
{
    /* set result pointer */
    *result = SCIP_SUCCESS;
...
SCIP_RETCODE ObjPricerUCPSwitchDecomposition::ucp_pricing(SCIP* scip)
{
    ...
    for(int i_time_step = 0; i_time_step < number_of_time_steps; i_time_step ++)
    {   
        FormulationPricerSwitchDecomposition* current_pricer = m_pricer_problems[i_time_step];
