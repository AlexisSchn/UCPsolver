...
/** 
 * @class FormulationMasterTimeDecomposition2pmin
 * 
...
#ifndef FormulationMasterTimeDecomposition2pmin_H
#define FormulationMasterTimeDecomposition2pmin_H
...
class FormulationMasterTimeDecomposition2pmin : public FormulationMaster
{
    ...
    public:
         ...
         *  constructor 
        */
        FormulationMasterTimeDecomposition2pmin( InstanceUCP* instance, SCIP* scip_master);

        /**
         *  destructor 
        */
        ~FormulationMasterTimeDecomposition2pmin();
