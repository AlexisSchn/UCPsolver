...
/** 
 * @class FormulationMasterTimeDecomposition2pmax
 * 
...
#ifndef FormulationMasterTimeDecomposition2pmax_H
#define FormulationMasterTimeDecomposition2pmax_H
...
class FormulationMasterTimeDecomposition2pmax : public FormulationMaster
{
    ...
    public:
         ...
         *  constructor 
        */
        FormulationMasterTimeDecomposition2pmax( InstanceUCP* instance, SCIP* scip_master);

        /**
         *  destructor 
        */
        ~FormulationMasterTimeDecomposition2pmax();
        ...
        */
        ...
        SCIP_Cons** get_constraint_pmaxpmin( int number_unit, int number_time_step );
        SCIP_Cons** get_constraint_demand( int number_time_step );
    ...
    private:
        ...
        std::vector< std::vector < SCIP_VAR* > > m_variables_p;
        ...
        std::vector< std::vector< SCIP_Cons* > > m_constraints_pmaxpmin;
