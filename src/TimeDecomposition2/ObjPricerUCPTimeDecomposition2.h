...
#ifndef ObjPricerUCPTimeDecomposition2_H
#define ObjPricerUCPTimeDecomposition2_H
...
class ObjPricerUCPTimeDecomposition2 : public ObjPricer
{
    ...
    public:
         ...
         * constructor
         */
        ObjPricerUCPTimeDecomposition2(
         ...
         * destructor
         */
        virtual ~ObjPricerUCPTimeDecomposition2();
    ...
    private:
        ...
        FormulationMasterTimeDecomposition2* m_formulation_master;
