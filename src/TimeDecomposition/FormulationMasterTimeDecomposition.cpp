...
/**
 * 
 *  Implements the class FormulationMasterTimeDecomposition
*/
...
FormulationMasterTimeDecomposition::FormulationMasterTimeDecomposition( InstanceUCP* instance, SCIP* scip_master):
...
FormulationMasterTimeDecomposition::~FormulationMasterTimeDecomposition()
{
...
SCIP_RETCODE FormulationMasterTimeDecomposition::create_variables()
{
...
SCIP_RETCODE FormulationMasterTimeDecomposition::create_constraints()
{
...
SCIP_RETCODE FormulationMasterTimeDecomposition::create_and_add_first_columns()
{
...
SCIP_RETCODE FormulationMasterTimeDecomposition::add_column( ProductionPlan* plan_of_new_column, bool initialization, int block_number ) 
{
    int number_of_time_steps( m_instance_ucp->get_time_steps_number() );
    int number_of_units( m_instance_ucp->get_units_number());
...
ProductionPlan* FormulationMasterTimeDecomposition::get_production_plan_from_solution()
{
...
SCIP_CONS** FormulationMasterTimeDecomposition::get_constraint_convexity( int number_block )
{
    return( &m_constraints_convexity[number_block]);
}

SCIP_Cons** FormulationMasterTimeDecomposition::get_constraint_min_uptime( int number_unit, int number_time_step )
{
    return( &m_constraints_min_uptime[number_unit][number_time_step]);
}

SCIP_Cons** FormulationMasterTimeDecomposition::get_constraint_min_downtime( int number_unit, int number_time_step )
{
    return( &m_constraints_min_downtime[number_unit][number_time_step]);
}

SCIP_Cons** FormulationMasterTimeDecomposition::get_constraint_switch( int number_unit, int number_time_step )
{
...
int FormulationMasterTimeDecomposition::get_columns_number()
{
