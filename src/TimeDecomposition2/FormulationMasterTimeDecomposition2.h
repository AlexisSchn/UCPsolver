...
/** 
 * @class FormulationMasterTimeDecomposition2
 * 
...
#ifndef FormulationMasterTimeDecomposition2_H
#define FormulationMasterTimeDecomposition2_H
...
class FormulationMasterTimeDecomposition2 : public FormulationMaster
{
    ...
    public:
         ...
         *  constructor 
        */
        FormulationMasterTimeDecomposition2( InstanceUCP* instance, SCIP* scip_master);

        /**
         *  destructor 
        */
        ~FormulationMasterTimeDecomposition2();
